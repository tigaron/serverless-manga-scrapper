...
var convertImg = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, source, slug, response, requestId, imgUrl, MangaSlug, convertResult, _iterator, _step, item, newUrl, timestamp, failedItems, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            convertResult = [];
            _iterator = _createForOfIteratorHelper(imgUrl);

            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                item = _step.value;
                newUrl = (0, _converter["default"])(item);
