...
describe("Unit test", function () {
  ...
  describe("scrapeManga behaviour", function () {
    test("Scraper return new data --> process scraped data --> respond 201", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var expectedUrlString, scraperSpy, getEntrySpy, createEntrySpy, req;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              scraperSpy = _scraper["default"].mockImplementation(function () {
                var result = new Map([["Id", "manga_luminous_a-returners-magic-should-be-special"], ["MangaSlug", "a-returners-magic-should-be-special"], ["MangaType", "series"], ["MangaProvider", "luminous"]]);
                return result;
              });
              getEntrySpy = _db["default"].getEntry.mockImplementation(function () {
                return null;
    ...
    test("Scraper return old data --> respond 409", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      var expectedUrlString, scraperSpy, getEntrySpy, createEntrySpy, req;
    ...
    test("Crawler/scraper failed to process request --> request aborted", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
