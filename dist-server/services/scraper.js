...
function parseMangaList($, mangaProvider) {
  ...
  $("a.series", "div.soralist").each(function (index, element) {
    ...
    var _MangaUrl$split$slice = MangaUrl.split("/").slice(-3, -1),
        _MangaUrl$split$slice2 = _slicedToArray(_MangaUrl$split$slice, 2),
...
function parseManga($, mangaProvider) {
  ...
  var MangaUrl = $("link[rel='canonical']").attr("href");

  var _MangaUrl$split$slice3 = MangaUrl.split("/").slice(-3, -1),
      _MangaUrl$split$slice4 = _slicedToArray(_MangaUrl$split$slice3, 2),
      MangaType = _MangaUrl$split$slice4[0],
...
function _scraper() {
  _scraper = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(urlString, requestType, mangaProvider) {
    var htmlString, $, parserDictionary, result;
