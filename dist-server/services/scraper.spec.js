...
describe("Integration test", function () {
  test("Scraper success", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var urlString, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            urlString = "https://www.asurascans.com/manga/list-mode/";
            _context.prev = 1;
            _context.next = 4;
            return (0, scraperService["default"])(urlString, "MangaList", "asura");
          ...
          case 8:
            ...
            expect(_context.t0.message).toBe("Failed to crawl '".concat(urlString, "'"));
            expect(_context.t0.cause).not.toEqual(200);
  ...
  test("Scraper fail", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var urlString, result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            urlString = "https://www.asurascans.com/manga/random-mode/";
            _context2.prev = 1;
            _context2.next = 4;
            return (0, scraperService["default"])(urlString, "MangaList", "asura");
          ...
          case 8:
            ...
            expect(_context2.t0.message).toBe("Failed to crawl '".concat(urlString, "'"));
            expect(_context2.t0.cause).not.toEqual(200);
